...
import { isBinaryFile, openDiff } from '../../common/fileUtils';
...
export class InMemFileChangeNode extends FileChangeNode implements vscode.TreeItem, IFileChangeNodeWithUri {
	constructor(
		...
		super(parent, pullRequest, status, fileName, previousFileName, blobUrl, filePath, parentFilePath, diffHunks, comments, sha, previousFileSha);
		this.command = {
			title: 'show diff',
			command: 'azdopr.openDiffView',
			arguments: [this],
